...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: 4zkLH3VD9NSul_/component
...
import * as sty from "./PlasmicSelect.module.css"; // plasmic-import: x4xcWpiY2aH-4f/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: oLfSdi5xVxUgB0/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: T0PGlkz8SOVUZd/icon
            ...
            >
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__h7Cb)}
    ...
    props = {
      ...
      children: (
        <React.Fragment>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option___3BxMo)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>

...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: S2fn3YcpXgI79h/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: x4xcWpiY2aH-4f/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__iq6Ae)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__gHvun)}
              />
            </React.Fragment>
          ),
          value: args.children

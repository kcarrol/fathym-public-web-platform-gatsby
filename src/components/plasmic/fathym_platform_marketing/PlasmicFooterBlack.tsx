...
import * as sty from "./PlasmicFooterBlack.module.css"; // plasmic-import: OF8nqCrALhqFVT/css

import HabistackLogosvgIcon from "./icons/PlasmicIcon__HabistackLogosvg"; // plasmic-import: 6U3g8sbxbRxf2K/icon
import blog01390X290Jpg2Nk5E8ReA9L6CKr from "./images/blog01390X290Jpg2.jpeg"; // plasmic-import: nk5e8reA9L6CKr/picture
import blog4390X290Jpg2CPxwXnDcGfxCsv from "./images/blog4390X290Jpg2.jpeg"; // plasmic-import: cPxwXnDCGfxCsv/picture
import blog2390X290Jpg2QxMrApEFo40Gz from "./images/blog2390X290Jpg2.jpeg"; // plasmic-import: qxMrAP_eFO40GZ/picture
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.columns__iMHma)}>
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.column___9DNdJ)}
            >
            ...
            <div className={classNames(projectcss.all, sty.column__yJ6Cu)}>
              <h5
                className={classNames(
                  projectcss.all,
                  projectcss.h5,
            ...
            <div className={classNames(projectcss.all, sty.column___5KiBi)}>
              <h5
                className={classNames(
                  projectcss.all,
                  projectcss.h5,
              ...
              <div className={classNames(projectcss.all, sty.columns__bOxgz)}>
                <div className={classNames(projectcss.all, sty.column__e0Ts)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__oBvo6)}
                    ...
                    src={{
                      src: blog01390X290Jpg2Nk5E8ReA9L6CKr,
                      fullWidth: 390,
                      fullHeight: 290,
                ...
                <div className={classNames(projectcss.all, sty.column__mnLux)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__cHfE2)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                    ...
                    loading={"lazy" as const}
                    src={{
                      src: blog4390X290Jpg2CPxwXnDcGfxCsv,
                      fullWidth: 390,
                      fullHeight: 290,
                      aspectRatio: undefined
                    }}
                ...
                <div className={classNames(projectcss.all, sty.column__lulxm)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__ckPOm)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                    ...
                    loading={"lazy" as const}
                    src={{
                      src: blog2390X290Jpg2QxMrApEFo40Gz,
                      fullWidth: 390,
                      fullHeight: 290,
                      aspectRatio: undefined
                    }}
              ...
              <div className={classNames(projectcss.all, sty.columns__ombzb)}>
                <div className={classNames(projectcss.all, sty.column__gTEhb)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__nuC)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                ...
                <div className={classNames(projectcss.all, sty.column__fqhxn)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img___0GuWw)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
                ...
                <div className={classNames(projectcss.all, sty.column__mrKp)}>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__k2MJz)}
                    displayHeight={"auto" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
